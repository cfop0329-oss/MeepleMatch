          ...
          <div className="relative bg-gradient-to-br from-amber-900 via-amber-800 to-amber-950 rounded-lg p-4 border-4 border-amber-950">
            ...
            <div className="relative parchment-bg rounded p-8 min-w-[420px]">
              ...
              <div className="text-center mb-6 relative z-10">
                ...
                <p className="font-lora text-sm" style={{ color: '#5c3a21' }}>{t('register', lang)} и найди свою игровую компанию</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                {/* ДОБАВЛЕНО ПОЛЕ ИМЕНИ */}
                <div>
                  <label className="block font-lora text-sm font-medium mb-2" style={{ color: '#5c3a21' }}>Имя</label>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required minLength={6} className="input-embossed w-full px-4 py-3 rounded font-lora" />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: '#5c3a21' }}>
                ...
                <button type="submit" disabled={isLoading} className="btn-wood w-full py-3.5 rounded font-cinzel font-bold text-lg flex items-center justify-center gap-2 disabled:opacity-70">
                  ...
                  {isLoading ? 'Регистрация...' : t('register', lang)}
                </button>
              </form>
              ...
              <div className="mt-6 text-center relative z-10">
                <p className="font-lora text-sm italic" style={{ color: '#5c3a21' }}>
                  {t('hasAccount', lang)}{' '}
                  <a href="/auth/login" className="font-bold hover:underline inline-flex items-center gap-1" style={{ color: '#2d1810' }}>
                    {t('login', lang)} <span>›</span>
                  </a>
                </p>
              </div>
            </div>
